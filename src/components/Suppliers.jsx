...
// import { Tile } from "../financial-transactions";
...
export default function Supplier() {
  ...
  async function handleDeleteSupplier(id) {
    ...
    setLoading(true);
    const response = await axios.post("/api/suppliers/delete-supplier", {
      id,
    });
      ...
      <Modal
        title={
          <div className="uppercase font-semibold">
            {showModal.type !== "edit" ? "Add New Supplier" : "Edit supplier"}
          </div>
        }
          ...
          <div className="p-5  py-3 rounded ">
            ...
            <div className="flex justify-end space-x-2 mt-2">
              ...
              <button
                ...
                onClick={() => {
                  handleDeleteSupplier(showDialog.content);
                }}
              >
                Yes
              </button>
